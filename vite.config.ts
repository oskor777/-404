...
<html lang="en">
  <head>
    ...
    <title>SBS-404 | AI Dasturlash Ustozi</title>
    <meta name="description" content="SBS-404 - AI yordamida dasturlashni o'rganing. HTML, CSS, JS, React, Backend va boshqalar." />
